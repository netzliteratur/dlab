...
"""
This module has been modified to use sha256 as default instead of md5
by: steffen fritz
contact: fritz@dla-marbach.de
date: 2014/08/27
...
checksum_algos = ['sha256', 'md5', 'sha1']
...
def make_bag(bag_dir, bag_info=None, processes=1):
    ...
    try:
        ...
        if unreadable_dirs or unreadable_files:
            ...
            logging.info("writing manifest-sha256.txt")
            Oxum = _make_manifest('manifest-sha256.txt', 'data', processes)
            ...
            bag_info['Bag-Software-Agent'] = 'bagit.py <https://github.com/ampoffcom/bagit>'
